                        ...
                        if (null != drawerLayout) {
                            ...
                            navigationView.setNavigationItemSelectedListener(
                                    menuItem -> {
                                        ...
                                        //Below code is throwing build errors as there is no reference to nav_admin or nav_settings
...
//                                        }
    ...
    private void deletePatient(String patientId) {
        FirebaseDatabase.getInstance().getReference("patient_profile").child(patientId)
                .removeValue()
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(PatientProfileActivity.this, "Patient deleted successfully", Toast.LENGTH_SHORT).show();
                    finish();
                })
                .addOnFailureListener(e -> Toast.makeText(PatientProfileActivity.this, "Failed to delete patient", Toast.LENGTH_SHORT).show());
    }
