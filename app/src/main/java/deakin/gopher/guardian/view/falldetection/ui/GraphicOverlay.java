...
public class GraphicOverlay extends View {
  ...
  public abstract static class Graphic {
    ...
    /**
     * Given the {@code zInImagePixel}, update the color for the passed in {@code paint}. The color
     * will be more red if the {@code zInImagePixel} is smaller, or more blue ish vice versa. This
     * is useful to visualize the z value of landmarks via color for features like Pose and Face
     * Mesh.
     *
