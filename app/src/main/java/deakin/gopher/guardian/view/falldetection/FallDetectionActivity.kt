...
class FallDetectionActivity : AppCompatActivity(), Player.Listener {
    ...
    companion object {
        ...
        // Adjust for more precision (degrees)
        private const val TORSO_HORIZONTAL_THRESHOLD = 20.0

        // Pixels; tweak based on video resolution
        private const val GROUND_LEVEL_THRESHOLD = 650.0
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channel =
                NotificationChannel("FALL_ALERTS", channelName, importance).apply {
