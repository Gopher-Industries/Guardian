...
public class Module1CoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Homecare Induction
        homecareInduction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Module1CoursesActivity.this, HomecareInductionActivity.class);
                startActivity(intent);
            }
        });

        // Infection Control
        infectionControl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        supportingMealtimes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Module1CoursesActivity.this, SupportingMealtimesActivity.class);
                startActivity(intent);
            }
        });
    }
