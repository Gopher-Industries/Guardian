...
public class GP_Adapter extends FirebaseRecyclerAdapter<GP_Model, GP_Adapter.myViewHolder> {

    public GP_Adapter(@NonNull FirebaseRecyclerOptions<GP_Model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, final int position, @NonNull GP_Model model) {
