...
public class GP_Model {
    String clinic_address, fax, first_name, middle_name, last_name, phone, photo, email;

    GP_Model(){

    }
    public GP_Model(String clinic_address, String fax, String first_name, String middle_name, String last_name, String phone, String photo, String email) {
