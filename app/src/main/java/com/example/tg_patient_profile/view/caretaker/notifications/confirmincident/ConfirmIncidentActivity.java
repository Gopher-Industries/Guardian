...
public class ConfirmIncidentActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final ArrayAdapter<CharSequence> hospitalAdapter = ArrayAdapter.createFromResource(getApplicationContext(), R.array.hospital_list_array, R.layout.spinner_layout);
    ...
    public void onConfirmIncidentCancelClick(final View view) {
        final Intent medicalDiagnosticsActivityIntent = new Intent(ConfirmIncidentActivity.this, CaretakerDashboardActivity.class);
