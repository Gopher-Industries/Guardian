...
public class CarePlanActivity extends AppCompatActivity {
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    final CheckBoxGroup<String> checkBoxGroup =
        new CheckBoxGroup<>(
            supportRequirementsCheckBox,
    ...
    final CheckBoxGroup<String> drinkLikesGroup =
        new CheckBoxGroup<>(
            drinkLikesCheckBox,
            new CheckBoxGroup.CheckedChangeListener<String>() {
              @Override
    ...
    final CheckBoxGroup<String> painGroup =
        new CheckBoxGroup<>(
            painCheckBox,
            new CheckBoxGroup.CheckedChangeListener<String>() {
              @Override
    ...
    final CheckBoxGroup<String> behavioralManagementGroup =
        new CheckBoxGroup<>(
            behavioralManagementCheckBox,
            new CheckBoxGroup.CheckedChangeListener<String>() {
              @Override
              public void onCheckedChange(final ArrayList<String> values) {
            ...
            builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(final DialogInterface dialog, final int whichButton) {
                    ...
                    //                intent.putExtra(Util.NUTRITION_HYDRATION_TYPE,
                    // nutritionHyrdration);
                    //                intent.putExtra(Util.SUPPORT_REQUIREMENTS,
                    // supportRequirements.toArray(new String[0]));
                    //                intent.putExtra(Util.DIET_TIMING, dietTiming);
                    //                intent.putExtra(Util.DRINK_LIKES, drinkLikes.toArray(new
                    // String[0]));
                    ...
                    //                intent.putExtra(Util.BEHAVIOUR_MANAGEMENT,
                    // behavioralManagement.toArray(new String[0]));
