                        ...
                        <div className="drawer-item-actions">
                          {!isRead && (
                            <button 
                              ...
                              onClick={() => markNotificationAsRead(notif._id).then(() => {
                                setNotifications(prev => prev.map(n => n._id === notif._id ? { ...n, read: true, isRead: true } : n));
                              })}
                              title="Mark as read"
                            >
                              <Check size={16} />
                          ...
                          <button 
                            ...
                            onClick={() => onDeleteRequest(notif._id)}
                            title="Delete"
                          >
                            <Trash2 size={16} />
                          </button>
